...
public class MSNHomePage extends PageObject {
	...
	@FindBy(xpath = "//div[contains(text(),'See more new')]")
	public WebElementFacade seeMoreBtn;

	String parentID;
	String inputSearchText;
	
	public Logger logger = LogManager.getLogger(MSNHomePage.class);
...
//		String data = it.next();
	...
	public void getTheText() throws InterruptedException {
		// TODO Auto-generated method stub
		Thread.sleep(3000);
		// String cssSelectorForHost1 = "body >
		// fluent-design-system-provider:nth-child(7) > entry-point-views:nth-child(1) >
		// consumption-feed-wc:nth-child(1) > fluent-design-system-provider:nth-child(1)
		// > div:nth-child(1) > div:nth-child(2) > consumption-page:nth-child(1) >
		// div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) >
		// div:nth-child(3) > views-header-wc:nth-child(1)";
		// Thread.sleep(1000);
		SearchContext shadow = getDriver().findElement(By.cssSelector(
				"body > fluent-design-system-provider:nth-child(7) > entry-point-views:nth-child(1) > consumption-feed-wc:nth-child(1) > fluent-design-system-provider:nth-child(1) > div:nth-child(1) > div:nth-child(2) > consumption-page:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > views-header-wc:nth-child(1)"))
				.getShadowRoot();
		Thread.sleep(1000);
		WebElement shadowText = shadow.findElement(By.cssSelector(".viewsHeaderText"));
		inputSearchText = shadowText.getText();
		System.out.println(inputSearchText);
	}
...
public void enterTextInSearch() throws InterruptedException {
	//This Element is inside 3 nested shadow DOM.
//	String cssSelectorForHost1 = "entry-point[config-instance-src='default']";
//	String cssSelectorForHost2 = "msn-homepage-header[data-t='{"n":"CommonHeader","t":8}']";
	//This Element is inside 3 nested shadow DOM.
	
	Thread.sleep(3000);
	WebElement searchText = getDriver().findElement(By.cssSelector("entry-point[config-instance-src='default']")).getShadowRoot()
.findElement(By.cssSelector("homepage-header[instance-id='HomepageHeader']")).getShadowRoot()
.findElement(By.cssSelector("msn-search-box")).getShadowRoot()
.findElement(By.cssSelector("#q"));
	Thread.sleep(2000);
	searchText.sendKeys(inputSearchText);
...
//	String cssSelectorForHost1 = "entry-point[config-instance-src='default']";
//	String cssSelectorForHost2 = "msn-homepage-header[data-t='{"n":"CommonHeader","t":8}']";
//	String cssSelectorForHost3 = "cs-common-search-box";
//	String cssSelectorForHost4 = ".search-btn.accent";
	
	WebElement searchbutton = getDriver().findElement(By.cssSelector("entry-point[config-instance-src='default']")).getShadowRoot()
	.findElement(By.cssSelector("homepage-header[instance-id='HomepageHeader']")).getShadowRoot()
	.findElement(By.cssSelector("msn-search-box")).getShadowRoot()
	.findElement(By.cssSelector("#q")).getShadowRoot()
	.findElement(By.cssSelector("fluent-button[part='button']"));
	searchbutton.click();
}
public void secondChild() throws InterruptedException {
	Thread.sleep(5000);
...
//	String data = it.next();
	...
	getDriver().switchTo().window(subChildID);
	
}
public void clickSeeMore() {
JavascriptExecutor js = (JavascriptExecutor) getDriver();
js.executeScript("arguments[0].click();", seeMoreBtn);
//((Object) js).executeScript("arguments[0].click();",seeMoreBtn);
